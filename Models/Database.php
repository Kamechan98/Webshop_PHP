...
class Database
{
    ...
    function initData()
    {
        ...
        $this->addProductIfNotExists(title: "Mythos", price: 5, imgUrl: "https://th.bing.com/th/id/OIP.eQBsGwoYctz-gA6yvIVQaQAAAA?rs=1&pid=ImgDetMain", stockLevel: 180, categoryName: "Books", popularityFactor: 4);
        ...
        $this->addProductIfNotExists(title: "Wicked", price: 15, imgUrl: "https://cdn.kinocheck.com/i/8mxyyhborj.jpg", stockLevel: 180, categoryName: "Movies", popularityFactor: 9);
        ...
        $this->addProductIfNotExists(title: "Into the Spiderverse", price: 120, imgUrl: "https://th.bing.com/th/id/OIP.u-03iGf1uJsiFRsKgd9_cgHaLH?rs=1&pid=ImgDetMain", stockLevel: 20, categoryName: "Movies", popularityFactor: 5);
        $this->addProductIfNotExists(title: "Iron Man", price: 110, imgUrl: "https://posterspy.com/wp-content/uploads/2021/03/Iron_Man-200th_Poster.jpg", stockLevel: 50, categoryName: "Movies", popularityFactor: 3);
